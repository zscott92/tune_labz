...
all credit goes to the talented artists that produced this music*/
class Samples {
    function() {
        const freesound = require("freesound");
        const router = require("express").Router();

        const clientId = 'vsj2MsgZOIL39ggebeKl';
        const clientSecret = 'hOovjhWMcGmK991RWwJL0CadgDvP2jivqoBJoesn';

        router.use(function (req, res) {
            authHeader = 'https://freesound.org/apiv2/oauth2/authorize/?client_id=' + clientId + '&response_type=code';
