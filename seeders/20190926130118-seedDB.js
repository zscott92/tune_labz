...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    return await queryInterface.bulkInsert('songs', [
      ...
      { key: "original", song_name: "Panini", song_desc: "original song", song_pic_url: "", song_genres: "rap, pop", song_id: 6, user_id: 1, song_par_id: 1 },
      { key: "original", song_name: "Truth Hurts", song_desc: "original song", song_pic_url: "", song_genres: "soul, pop", song_id: 7, user_id: 2, song_par_id: 1 },
      { key: "original", song_name: "Dyer Maker", song_desc: "original song", song_pic_url: "", song_genres: "rock", song_id: 8, user_id: 3, song_par_id: 1 },
